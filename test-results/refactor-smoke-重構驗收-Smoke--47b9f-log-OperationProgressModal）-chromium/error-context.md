...
- Name: refactor-smoke.spec.ts >> 重構驗收 Smoke 測試 >> /manifests 清單頁面能載入（重構：useManifestOperations + DeleteConfirmDialog + OperationProgressModal）
- Location: tests\e2e\refactor-smoke.spec.ts:91:7
