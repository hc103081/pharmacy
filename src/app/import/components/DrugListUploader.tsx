    ...
    <div className="space-y-3">
      ...
      <div
        ...
        className={`
          ...
          ${isDragOver
            ? 'border-[#00f2fe] bg-[#00f2fe]/5 shadow-[0_0_30px_rgba(0,242,254,0.15)] scale-[1.01]'
      ...
      >
        {/* 拖曳中提示覆蓋層 */}
        {isDragOver && (
          <div className="absolute inset-0 rounded-2xl bg-[#00f2fe]/5 flex flex-col items-center justify-center z-10">
